...
* Además, algunos textos están codificados en **XML** siguiendo el estándar de la [Text Encoding Initiative](https://tei-c.org/) (**TEI**). En los archivos XML se indica la edición base sobre la que se ha trabajado.
